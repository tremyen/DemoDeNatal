...
220 ' ---------------
230 PRESET(70,90): PRINT#1,"cRAzY SaNtA"
240 PRESET(60,100): PRINT#1,"By Manoel Neto"
245 PRESET(20,110): PRINT#1,"Aperte <espaco> para jogar"
250 X=CINT((RND(1)*240))
260 Y=CINT((RND(1)*180))
270 S=CINT((RND(1)*2))
280 'PRESET(1,1): PRINT#1,"                                 "
290 'PRESET(1,1): PRINT#1,"VALOR DE S:"+STR$(S)
300 IF S=0 THEN GOSUB 2000
310 IF S=1 THEN GOSUB 3000
320 IF STRIG(0)=0 GOTO 250
330 RETURN      
